...
- Alkene là những hydrocarbon mạch hở, chỉ chứa các liên kết đơn và một liên kết đôi C=C trong phân tử, có công thức chung $C_nH_{2n}$ (n ≥ 2).
- Alkyne là những hydrocarbon mạch hở, chỉ chứa liên kết đơn và một liên kết ba C≡C trong phân tử, có công thức chung $C_nH_{2n-2}$ (n ≥ 2).
...
CH₂=CH₂ + H₂O $\xrightarrow{H₃PO₄, t°}$ CH₃–CH₂–OH (ethanol)                   
...
HC≡CH + 2[Ag(NH₃)₂]OH → AgC≡CAg↓ + 4NH₃ + 2H₂O (màu vàng nhạt)                          
...
2. Viết công thức khung phân tử của:
   ...
   d) *cis*-but-2-ene.
4. Viết công thức cấu tạo sản phẩm chính của các phản ứng sau:
