...
| TT | Các công việc cần thực hiện | Yêu cầu kĩ thuật |
|---|---|---|
...
1. Theo em, quy trình trồng cải xanh vừa học đã áp dụng các biện pháp trồng trọt hữu cơ như thế nào?

Bảng 5.5. Các bước thu hoạch cây cải xanh

| TT | Các bước cần thực hiện | Yêu cầu kĩ thuật |
|---|---|---|
