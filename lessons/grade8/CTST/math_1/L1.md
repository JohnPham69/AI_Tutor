...
4.  Tính giá trị của đa thức $P = 3x^2y - 6xy + 8xz + xy^2 - 10xz$ tại $x = -3; y = - \frac{1}{2}; z = 3$.

5.  Viết biểu thức biểu thị thể tích $V$ và diện tích xung quanh $S$ của hình hộp chữ nhật.
