...
def refine_quiz_quality(raw_quiz_json: list, user_api: str, user_model: str = "gemini-2.5-flash-live"):
    """
...
def balance_quiz_set(refined_quiz_json: list, user_api: str, user_model: str = "gemini-2.5-flash-live"):
    """
